export const orders = {
  ...
  review: {
    title: 'تحت المراجعة',
    badge: '⚠️ تحت المراجعة',
    empty: 'لا توجد طلبات بانتظار المراجعة.',
    reason: 'سبب إعادة الفتح / المراجعة',
    lastEdit: 'آخر تعديل',
  ...
  reopen: {
    action: 'إعادة فتح الطلب',
    title: 'إعادة فتح طلب محصّل',
    hint: 'لإضافة أصناف بعد الدفع. يتحول الطلب إلى «تحت المراجعة»، ويُحصّل الفرق فقط دون المساس بالتحصيل السابق.',
    reason: 'سبب إعادة الفتح',
    reasonPlaceholder: 'مثال: العميل طلب مشروبًا إضافيًا',
    confirm: 'تأكيد إعادة الفتح',
    done: 'تم إعادة فتح الطلب — يمكنك إضافة أصناف الآن.',
    append: 'إضافة أصناف',
    appendTitle: 'إضافة أصناف للطلب',
    appendDone: 'تمت إضافة الأصناف. حصّل الفرق المتبقي.',
  },
  status: {
    payment: {
      unpaid: 'غير محصّل',
  ...
  errors: {
    ...
    REOPEN_REQUIRED: 'أعد فتح الطلب أولًا قبل إضافة أصناف.',
    APPEND_MUST_INCREASE_TOTAL: 'يجب أن تزيد الأصناف المضافة من إجمالي الطلب.',
  },
} as const
