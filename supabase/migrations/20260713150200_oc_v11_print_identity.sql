-- OC v1.1: add created_by / collected_by responsibility fields to order print snapshot
...
BEGIN
  ...
  SELECT cs.display_name, op.created_at INTO v_collected, v_collected_at
  ...
  v_snapshot := jsonb_build_object(
    ...
    'cashier', v_cashier,
    'created_by_name', coalesce(v_cashier, ''),
    'created_at', v_o.created_at,
    'collected_by_name', coalesce(v_collected, ''),
