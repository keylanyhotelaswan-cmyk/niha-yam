-- Restore null-safe payload stamping in m6_enqueue_document_print.
-- Regression: 20260714140000 rewrote enqueue for claim/routing and dropped the
-- coalesce / PRINT_PAYLOAD_NULL guards from 20260711030200. When payload
-- collapsed to SQL NULL, POS finalize failed with:
--   null value in column "payload" of relation "print_jobs"
