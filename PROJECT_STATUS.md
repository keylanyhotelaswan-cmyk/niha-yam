...
### سياسة الحركات المالية (2026-07-19)

كل حركة تؤثر على درج الكاشير أو الخزنة: **تنفيذ فوري** → مراجعة → **رفض = عكس** (append-only).  
لا خطوة اعتماد (Approve) للمصروفات / التحويلات / الإيداع-السحب / تحصيلات POS / غلق Path A.  
Path B (تسليم للوردية التالية) يبقى استلام مادي عند الفتح.
